...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("D:\M.TECH DATA SCIENCE\placement\MY_PROJECTS\Disease-prediction-using-Machine-Learning-master\Disease-prediction-using-Machine-Learning-master\Testing.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("D:\M.TECH DATA SCIENCE\placement\MY_PROJECTS\Disease-prediction-using-Machine-Learning-master\Disease-prediction-using-Machine-Learning-master\Training.csv")
